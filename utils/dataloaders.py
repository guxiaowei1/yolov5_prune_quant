...
IMG_FORMATS = 'bmp', 'dng', 'jpeg', 'jpg', 'mpo', 'png', 'tif', 'tiff', 'webp', 'JPG'  # include image suffixes
...
class LoadImagesAndLabels(Dataset):
    ...
    def load_mosaic(self, index):
        ...
        # for box_ind in range(labels4.shape[0]):
        #     cv2.rectangle(img4, (int(labels4[box_ind][1]), int(labels4[box_ind][2])), \
        #         (int(labels4[box_ind][3]), int(labels4[box_ind][4])), (0,0,255), 2)
        #     cv2.putText(img4, str(labels4[box_ind][0]), (int(labels4[box_ind][1]), int(labels4[box_ind][2])),\
        #         cv2.FONT_HERSHEY_COMPLEX, 2.0, (100, 200, 200), 5)
        # cv2.imwrite('/home/guxiaowei/mosaic.jpg', img4)
        return img4, labels4

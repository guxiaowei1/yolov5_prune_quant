...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/guxiaowei/yolov5-master/runs/train/bozhou_n_640/weights/best.pt', help='model.pt path(s)')
